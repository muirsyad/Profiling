                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="" method="#">
                                    @csrf
                                    <table id="example" class="table table-striped table-yello" style="width:100%">
                                        <thead class="table-warning">
                                            <tr>
                                                <th style="width: 10%">No</th>
                                                <th style="width: 10%">Qustion</th>
                                        ...
                                        <tbody>
                                            @foreach ($grp as $questions)
                                                <tr>
                                                    ...
                                                    <td><input type="radio" value="{{ $questions->value }}"
                                                            name="Q{{ $questions->group_id }}"
                                                            id="Q{{ $questions->group_id }}">
                                                    </td>
                                                </tr>
                                            @endforeach
